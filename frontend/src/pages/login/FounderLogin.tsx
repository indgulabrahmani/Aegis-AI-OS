    ...
    <div className="min-h-screen bg-background flex items-center justify-center p-8 relative overflow-hidden">
      ...
      >
        ...
        >
          ...
          <h1 className="text-3xl font-bold text-text mb-2">Founder Portal</h1>
          ...
          {mode === 'forgot' ? (
            <form onSubmit={handleForgotPassword} className="space-y-6">
              <div>
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    className={`w-full pl-10 pr-4 py-3 bg-surface/50 border rounded-xl text-text placeholder:text-textMuted/50 focus:outline-none focus:ring-2 focus:ring-primary/50 transition-all duration-300 ${
              ...
              <motion.button
                ...
                type="submit"
                disabled={isLoading}
                className="w-full py-3 px-6 bg-gradient-to-r from-primary to-accent rounded-xl text-white font-semibold flex items-center justify-center gap-2 disabled:opacity-50 disabled:cursor-not-allowed glow-primary"
              >
                {isLoading ? (
                  <>
              ...
              {mode === 'signup' && (
                <div>
                  ...
                  <input
                    ...
                    className={`w-full px-4 py-3 bg-surface/50 border rounded-xl text-text placeholder:text-textMuted/50 focus:outline-none focus:ring-2 focus:ring-primary/50 transition-all duration-300 ${
              ...
              <div>
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    placeholder="••••••••"
                    className={`w-full pl-10 pr-12 py-3 bg-surface/50 border rounded-xl text-text placeholder:text-textMuted/50 focus:outline-none focus:ring-2 focus:ring-primary/50 transition-all duration-300 ${
                ...
                <div className="flex items-center justify-between">
                  <label className="flex items-center gap-2 cursor-pointer">
                    <input
                      ...
                      className="w-4 h-4 rounded border-border/50 bg-surface/50 text-primary focus:ring-primary/50"
                    />
